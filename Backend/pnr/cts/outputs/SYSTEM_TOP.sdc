...
#
# Created by icc2 write_sdc on Wed Sep  3 19:17:12 2025
#
################################################################################
...
set_propagated_clock [get_clocks {FUN_REF_CLK}]
set_propagated_clock [get_clocks {FUN_UART_CLK}]
set_propagated_clock [get_clocks {FUN_TX_CLK}]
set_propagated_clock [get_clocks {FUN_RX_CLK}]
set_propagated_clock [get_clocks {ALU_CLK}]
...
# -origin user
set_clock_latency -min 0.392761 [get_clocks {FUN_REF_CLK}]
# -origin user
set_clock_latency -max 1.46065 [get_clocks {FUN_REF_CLK}]
# -origin user
set_clock_latency -min 0.562258 [get_clocks {FUN_UART_CLK}]
# -origin user
set_clock_latency -max 2.24114 [get_clocks {FUN_UART_CLK}]
# -origin user
set_clock_latency -min 0.104675 [get_clocks {FUN_TX_CLK}]
# -origin user
set_clock_latency -max 0.60936 [get_clocks {FUN_TX_CLK}]
# -origin user
set_clock_latency -min 0.104637 [get_clocks {FUN_RX_CLK}]
# -origin user
set_clock_latency -max 0.632553 [get_clocks {FUN_RX_CLK}]
# -origin user
set_clock_latency 0 [get_clocks {ALU_CLK}]
# Set propagated on clock sources to avoid removing latency for IO paths.
set_propagated_clock  [get_pins {U0_CLK_GATE/GATED_CLK}]
set_propagated_clock  [get_ports {FUN_REF_CLK}]
set_propagated_clock  [get_pins {RX_CLK_DIV/o_div_clk}]
set_propagated_clock  [get_pins {TX_CLK_DIV/o_div_clk}]
set_propagated_clock  [get_ports {FUN_UART_CLK}]
...
set_input_transition -rise 0.3 [get_ports {FUN_REF_CLK}]
set_input_transition -fall 0.2 [get_ports {FUN_REF_CLK}]
set_input_transition -rise 0.3 [get_ports {FUN_UART_CLK}]
set_input_transition -fall 0.2 [get_ports {FUN_UART_CLK}]
set_input_transition -rise 0.3 [get_ports {SCAN_CLK}]
set_input_transition -fall 0.2 [get_ports {SCAN_CLK}]
# /home/ICer/Projects/Digital_System(RTL-to-GDSII)/dft/outputs/SYSTEM_TOP.sdc, \
#   line 15
set_driving_cell -lib_cell INVX8 -pin ZN -max -library \
...
set_max_transition 0.1 [get_clocks {FUN_REF_CLK}] -clock_path
set_max_transition 0.1 [get_clocks {FUN_UART_CLK}] -clock_path
set_max_transition 0.1 [get_clocks {FUN_TX_CLK}] -clock_path
set_max_transition 0.1 [get_clocks {FUN_RX_CLK}] -clock_path
set_max_transition 0.1 [get_clocks {ALU_CLK}] -clock_path
set_max_transition 0.1 [get_clocks {SCAN_CLK}] -clock_path
