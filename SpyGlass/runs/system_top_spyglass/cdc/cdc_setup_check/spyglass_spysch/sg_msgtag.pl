...
spyParseTextMessageTagFile("./system_top_spyglass/cdc/cdc_setup_check/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(19,"./system_top_spyglass/cdc/cdc_setup_check/spyglass.vdb");
