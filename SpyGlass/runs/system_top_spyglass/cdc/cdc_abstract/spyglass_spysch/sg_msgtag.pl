...
spyParseTextMessageTagFile("./system_top_spyglass/cdc/cdc_abstract/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(17,"./system_top_spyglass/cdc/cdc_abstract/spyglass.vdb");
