...
spyParseTextMessageTagFile("./system_top_spyglass/cdc/clock_reset_integrity/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(9,"./system_top_spyglass/cdc/clock_reset_integrity/spyglass.vdb");
