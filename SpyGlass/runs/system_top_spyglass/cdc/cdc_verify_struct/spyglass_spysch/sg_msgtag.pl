...
spyParseTextMessageTagFile("./system_top_spyglass/cdc/cdc_verify_struct/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(82,"./system_top_spyglass/cdc/cdc_verify_struct/spyglass.vdb");
